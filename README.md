...
Please open an issue or pull request. Make sure your code follows the existing RAII style and is noexcept where possible.

📄 License
MIT License – see the header file for full text.

🌟 Show your support
Give a ⭐️ if this library saved you time!
